...
defined('_JEXEC') or die;
	...
	if ($saveOrder)
	{
		$saveOrderingUrl = "index.php?option=$option&task=turningpoints.saveOrderAjax&tmpl=component";
...
<script language="javascript">
	...
	Joomla.submitbutton = function(pressbutton){
		if(pressbutton=="turningpoints.delete"){
	...
	<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_tourismtour&view=turningpoints'); ?>" method="post" name="adminForm" id="adminForm">
        ...
        <table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th><?php echo JHtml::_('searchtools.sort','turningpoint_fld_name', 'a.fld_name', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort','turningpoint_fld_url_info', 'a.fld_url_info', $listDirn, $listOrder); ?></th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center"><?php echo JHtml::_('jgrid.published', $item->published, $i, 'turningpoints.', 1);?></td>
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_tourismtour&task=turningpoint.edit&id='.(int) $item->id); ?>"><?php echo JText::_("EDIT"); ?></a>
						<br />
						<small><?php echo $item->alias;?></small>
					</td>
					<td><?php echo $item->fld_name;?></td>
					<td><?php echo $item->fld_url_info;?></td>
