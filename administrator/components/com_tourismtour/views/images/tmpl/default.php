...
defined('_JEXEC') or die;
	...
	if ($saveOrder)
	{
		$saveOrderingUrl = "index.php?option=$option&task=images.saveOrderAjax&tmpl=component";
...
<script language="javascript">
	...
	<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_tourismtour&view=images'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th><?php echo JHtml::_('searchtools.sort','image_fld_src', 'a.fld_src', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort','image_fld_type', 'a.fld_type', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort','image_fld_title', 'a.fld_title', $listDirn, $listOrder); ?></th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center"><?php echo JHtml::_('jgrid.published', $item->published, $i, 'images.', 1);?></td>
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_tourismtour&task=image.edit&id='.(int) $item->id); ?>"><?php echo JText::_("EDIT"); ?></a>
						<br />
						<small><?php echo $item->alias;?></small>
					</td>
					<td><?php echo $item->fld_src;?></td>
					<td><?php echo $item->fld_type;?></td>
