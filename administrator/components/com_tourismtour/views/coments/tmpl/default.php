...
defined('_JEXEC') or die;
	...
	if ($saveOrder)
	{
		$saveOrderingUrl = "index.php?option=$option&task=coments.saveOrderAjax&tmpl=component";
...
<script language="javascript">
	...
	<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_tourismtour&view=coments'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th><?php echo JHtml::_('searchtools.sort','coment_fld_title', 'a.fld_title', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort','coment_fld_tour_id', 'a.fld_tour_id', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort','coment_fld_user_id', 'a.fld_user_id', $listDirn, $listOrder); ?></th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center"><?php echo JHtml::_('jgrid.published', $item->published, $i, 'coments.', 1);?></td>
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_tourismtour&task=coment.edit&id='.(int) $item->id); ?>"><?php echo JText::_("EDIT"); ?></a>
						<br />
						<small><?php echo $item->alias;?></small>
					</td>
					<td><?php echo $item->fld_title;?></td>
					<td><?php echo $item->fld_tour_id;?></td>
					<td><?php echo $this->userid[$item->fld_user_id];?></td>
