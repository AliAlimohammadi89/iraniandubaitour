...
//$document->addScript('modules/mod_joomla_news/assets/jquery.min.js');
$document = JFactory::getDocument();
// Include the syndicate functions only once
require_once dirname(__FILE__).'/helper.php';
$list = ModjoomlaNEWSHelper::getList($params);
require JModuleHelper::getLayoutPath('mod_joomla_news', $params->get('layout', 'default'));
