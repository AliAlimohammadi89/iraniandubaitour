	...
	<?php foreach ($list as $item) : ?>
			<li class="page_item <?php echo ($clrCounter++ % 2 == 0 ? 'row1' : 'row0'); ?>">
            	<div class="photo span3" style="height:<?php echo $height; ?>px;">
                    ...
                    <img src="<?php echo  $item->thumb; ?>" alt="<?php echo ($item->text); ?>" title="<?php echo ($item->text); ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>"  style="height:<?php echo $height; ?>px;"  />
                    </a>
                </div>
            	<div class="text span4" style="height:<?php echo $height; ?>px;">
            	...
            	<div class="info span3" style="height:<?php echo $height; ?>px;">
                	<div class="id">
                    	<span>شماره:</span> <?php echo $item->id ; ?>
                    </div>
                    <div class="category">
                    	<span>مجموعه:</span> <?php echo $item->category ; ?>
                    </div>
                    <div class="hits">
                    	<span>بازدید:</span> <?php echo $item->hits ; ?>
                    </div>
                    <div class="date">
                    	<span>تاریخ:</span> <?php echo (JHTML::_('date',$item->date,'d M')) ; ?>
                    </div>
                </div>
            	<div class="nicons span2" style="height:<?php echo $height; ?>px;">
                	<div class="comment">
                    	<span><?php echo $item->comment ; ?> نظر</span>
                    </div>
                	<div class="author">
                    	<span><?php echo $item->owner ; ?></span>
                    </div>
                	<div class="date">
                    	<span><?php echo (JHTML::_('date',$item->date,'d M')) ; ?></span>
                    </div>
                </div>
			</li>
	<?php endforeach; ?>
