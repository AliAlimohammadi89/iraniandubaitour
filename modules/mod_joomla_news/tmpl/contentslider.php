...
$document->addStyleSheet('modules/mod_joomla_news/assets/contentslider.css');
...
<div class="slider1">
	<div id="slider<?php echo $module->id ?>" class="sliderwrapper" style="height:<?php echo $height+20; ?>px;">
		<?php foreach ($list as $item) : ?>
		   <div class="contentdiv" style="height:<?php echo $height+20; ?>px;">
			<div class="text2" style="height:<?php echo $height+20; ?>px;">
