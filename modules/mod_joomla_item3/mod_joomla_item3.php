...
$item3readon		= $params->get('item3readon');
$item3cat		= $params->get('item3cat');
$item3date		= $params->get('item3date');
$item3hits		= $params->get('item3hits');
...
//$document->addScript('modules/mod_joomla_item3/assets/jquery.min.js');
$document = JFactory::getDocument();
// Include the syndicate functions only once
require_once dirname(__FILE__).'/helper.php';
$list = Modjoomlaitem3Helper::getList($params);
require JModuleHelper::getLayoutPath('mod_joomla_item3', $params->get('layout', 'default'));
