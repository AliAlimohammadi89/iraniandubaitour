...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        function init(){
            ...
            g.find(".nav").children("li").css("height","49px").css("background-image","url(modules/mod_joomla_ITEM5/assets/modules/mod_joomla_ITEM5/assets/images/flashtext-bg.jpg)").css("line-height","49px").css("border-bottom","1px solid #CCCCCC").css("border-right","1px solid #CCCCCC");
        ...
        function showpic(){
            clearTimeout(v);
            g.find(".nav").children("li").css("background-image","url(modules/mod_joomla_ITEM5/assets/images/flashtext-bg.jpg)").css("border-bottom","1px solid #CCCCCC");
            g.find(".nav").children("li").eq(current).css("background-image","url(modules/mod_joomla_ITEM5/assets/images/flash-on.gif)").css("border-bottom","none");
