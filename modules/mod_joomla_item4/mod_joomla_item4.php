...
$item4readon		= $params->get('item4readon');
$item4cat		= $params->get('item4cat');
$item4date		= $params->get('item4date');
$item4hits		= $params->get('item4hits');
...
//$document->addScript('modules/mod_joomla_item4/assets/jquery.min.js');
$document = JFactory::getDocument();
// Include the syndicate functions only once
require_once dirname(__FILE__).'/helper.php';
$list = ModjoomlaITEM4Helper::getList($params);
require JModuleHelper::getLayoutPath('mod_joomla_item4', $params->get('layout', 'default'));
